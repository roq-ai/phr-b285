...
export function PatientListPage(props: PatientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPatients({
        relations: [
          'user',
          'insurance_detail.count',
          'laboratory_result.count',
          'medical_record.count',
          'prescription.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('insurance_detail', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'insurance_detail',
          header: 'Insurance Detail',
          accessorKey: 'insurance_detail',
          cell: ({ row: { original: record } }: any) => record?._count?.insurance_detail,
        }
      : null,
    hasAccess('laboratory_result', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'laboratory_result',
          header: 'Laboratory Result',
          accessorKey: 'laboratory_result',
          cell: ({ row: { original: record } }: any) => record?._count?.laboratory_result,
        }
      : null,
