...
import { getInsuranceDetailById } from 'apiSdk/insurance-details';
import { InsuranceDetailInterface } from 'interfaces/insurance-detail';

function InsuranceDetailViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Insurance Detail Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Insurance Detail Details
                  </Text>
                </Box>
                {hasAccess('insurance_detail', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/insurance-details/edit/${id}`} passHref legacyBehavior>
                    <Button
